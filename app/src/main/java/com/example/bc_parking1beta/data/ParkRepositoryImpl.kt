...
//        addParkItem(parkItem)
    ...
    override suspend fun addParkItem(parkItem: ParkItem) {
        parkListDao.addParkItem(mapper.mapEntityToDbModel(parkItem))
...
//        updateList()
    ...
    override suspend fun getParkItem(parkItemId: Int): ParkItem {
...
//        } ?: throw RuntimeException("Element with id $parkItemId not found")
    ...
    override suspend fun deleteParkItem(parkItem: ParkItem) {
